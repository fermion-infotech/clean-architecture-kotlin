...
android {
    namespace = "com.learning.whatsappclone"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.learning.whatsappclone"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
    ...
    productFlavors {
        create("staging") {
            ...
            applicationId = "com.learning.whatsappclone.staging"
            minSdk = 24
            targetSdk = 34
            versionCode = 1
            versionName = "1.0"
        ...
        create("preprod") {
            dimension = "environment"
            applicationId = "com.learning.whatsappclone.preprod"
            minSdk = 24
            targetSdk = 34
            versionCode = 1
            versionName = "1.0"
